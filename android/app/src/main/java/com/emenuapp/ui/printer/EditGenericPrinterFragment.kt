...
import com.emenuapp_pk.databinding.FragmentEditGenericPrinterBinding
...
class EditGenericPrinterFragment :
    BaseFragment<FragmentEditGenericPrinterBinding>(R.layout.fragment_edit_generic_printer) {
    ...
    override fun provideBinding(view: View): FragmentEditGenericPrinterBinding {
        return FragmentEditGenericPrinterBinding.bind(view)
    }
