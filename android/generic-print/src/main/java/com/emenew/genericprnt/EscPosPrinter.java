...
import com.emenew.genericprnt.textparser.IPrinterTextParserElement;
import com.emenew.genericprnt.textparser.PrinterTextParser;
import com.emenew.genericprnt.textparser.PrinterTextParserColumn;
import com.emenew.genericprnt.textparser.PrinterTextParserLine;
import com.emenew.genericprnt.textparser.PrinterTextParserString;
...
public class EscPosPrinter extends EscPosPrinterSize {
     ...
     * @return Fluent interface
     */
    public EscPosPrinter printFormattedTextAndOpenCashBox(String text) throws EscPosConnectionException, EscPosParserException, EscPosEncodingException, EscPosBarcodeException {
        return this.printFormattedTextAndOpenCashBox(text, 20f);
    }
     ...
     * @return Fluent interface
     */
    public EscPosPrinter openCashDrawer() throws EscPosConnectionException {
        if (this.printer == null) {
            return this;
        }
